...
class AccessBankSummaryDetail extends StatefulWidget {
  ...
  @override
  _AccessBankSummaryDetailState createState() => _AccessBankSummaryDetailState(
...
class _AccessBankSummaryDetailState extends State<AccessBankSummaryDetail> {
  ...
  deleteBankRequest(String id) async {
    ...
    if (response.statusCode == 204) {
      ...
      sendSms.sendMySms(
          telnum, "FNET", "Hello,your Access Bank request is cancelled");
