...
class CalBankDepositRequests extends StatefulWidget {
  final username;
  const CalBankDepositRequests({super.key,required this.username});

  @override
  State<CalBankDepositRequests> createState() => _CalBankDepositRequestsState(username:this.username);
}

class _CalBankDepositRequestsState extends State<CalBankDepositRequests> {
  final username;
  _CalBankDepositRequestsState({required this.username});
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context){
                      return CalBankSummaryDetail(date_requested:requestsDates[i],username:username);
                    }));
                  },
                  child: Padding(
