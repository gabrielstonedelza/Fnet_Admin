...
class CalBankSummaryDetail extends StatefulWidget {
  ...
  @override
  _CalBankSummaryDetailState createState() => _CalBankSummaryDetailState(
...
class _CalBankSummaryDetailState extends State<CalBankSummaryDetail> {
  ...
  deleteBankRequest(String id) async {
    ...
    if (response.statusCode == 204) {
      ...
      sendSms.sendMySms(
          telnum, "FNET", "Hello,your Calbank request is cancelled");
