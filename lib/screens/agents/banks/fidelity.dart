...
class FidelityBankDepositRequests extends StatefulWidget {
  ...
  const FidelityBankDepositRequests(
      {super.key, required this.username, required this.phone});

  @override
  State<FidelityBankDepositRequests> createState() =>
      _FidelityBankDepositRequestsState(
          username: this.username, phone: this.phone);
}

class _FidelityBankDepositRequestsState
    extends State<FidelityBankDepositRequests> {
  final username;
  final phone;
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(context,
                          ...
                          return FidelityBankSummaryDetail(
