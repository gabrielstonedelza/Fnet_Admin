...
class GtBankDepositRequests extends StatefulWidget {
  final username;
  const GtBankDepositRequests({super.key,required this.username});

  @override
  State<GtBankDepositRequests> createState() => _GtBankDepositRequestsState(username:this.username);
}

class _GtBankDepositRequestsState extends State<GtBankDepositRequests> {
  final username;
  _GtBankDepositRequestsState({required this.username});
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context){
                      return GTBankSummaryDetail(date_requested:requestsDates[i],username:username);
                    }));
                  },
                  child: Padding(
