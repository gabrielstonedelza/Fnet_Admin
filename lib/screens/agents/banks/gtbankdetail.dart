...
class GTBankSummaryDetail extends StatefulWidget {
  ...
  final username;
  const GTBankSummaryDetail({Key? key, this.date_requested,required this.username})
      : super(key: key);

  @override
  _GTBankSummaryDetailState createState() =>
      _GTBankSummaryDetailState(date_requested: this.date_requested,username:this.username);
}

class _GTBankSummaryDetailState extends State<GTBankSummaryDetail> {
  final date_requested;
  final username;
  _GTBankSummaryDetailState({required this.date_requested,required this.username});
