...
class _GetMyAccountsAndPullState extends State<GetMyAccountsAndPull> {
  ...
  Future<void> openOwnerFinancialServicesPullFromBank(
      String bankNum, String linkedNum, String amount) async {
    await UssdAdvanced.multisessionUssd(
        code: "*171*6*1*2*$bankNum*$linkedNum*$amount#", subscriptionId: 1);
  }
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: DropdownButton(
                                      ...
                                      items:
                                          userBanks.map((dropDownStringItem) {
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding:
                                        const EdgeInsets.only(bottom: 10.0),
                                    child: TextFormField(
                                      controller: _agentAccountNameController
                                  ...
                                  Padding(
                                    padding:
                                        const EdgeInsets.only(bottom: 10.0),
                                    child: TextFormField(
                                      controller: _agentLinkedNumController
                                        ..text = agentAccountLinkedNumber,
                                      cursorColor: secondaryColor,
                                      cursorRadius:
                                          const Radius.elliptical(10, 10),
                                      cursorWidth: 10,
                          ...
                          onPressed: () {
                            if (!_formKey.currentState!.validate()) {
                              ...
                              switch (_currentSelectedBank) {
                                case "Zenith Bank":
                                  openOwnerFinancialServicesPullFromBank(
                                      "1",
                                      agentAccountLinkedNumber,
