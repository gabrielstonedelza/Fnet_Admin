...
class AllPoints extends StatefulWidget {
  const AllPoints({super.key});

  @override
  State<AllPoints> createState() => _AllPointsState();
}

class _AllPointsState extends State<AllPoints> {
  ...
  void initState() {
    ...
    controller.getAllAccountsWithPoints(uToken);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("All Points"),
        ),
        body: GetBuilder<PointsController>(builder: (controller) {
          return ListView.builder(
              itemCount:
                  controller.points != null ? controller.points.length : 0,
              itemBuilder: (context, index) {
                items = controller.points[index];
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      children: [
                        ...
                        // RowWidget(items: items, title: 'Points: ', itemTitle: 'points'.toString(),),
                        Row(
                          children: [
                            const Padding(
