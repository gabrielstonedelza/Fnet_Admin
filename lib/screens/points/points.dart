          ...
          Row(
            children: [
              Expanded(child: GestureDetector(
                ...
                child:  menuWidget(title: 'Today', imagePath: 'assets/images/customer-loyalty.png',),
              )),
              Expanded(child: GestureDetector(
                onTap: (){
                  Get.to(() => const PointsForWeek());
                },
                child:  menuWidget(title: 'Weekly', imagePath: 'assets/images/customer-loyalty.png',),
              )),
              Expanded(child: GestureDetector(
                onTap: (){
                  Get.to(() => const PointsForMonth());
                },
                child: menuWidget(title: 'Monthly', imagePath: 'assets/images/customer-loyalty.png',),
              )),
              Expanded(child: GestureDetector(
                onTap: (){
                  Get.to(() => const AllPoints());
                },
                child: menuWidget(title: 'All', imagePath: 'assets/images/customer-loyalty.png',),
              )),
            ],
          ),
        ],
